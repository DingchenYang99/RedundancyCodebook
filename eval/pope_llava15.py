...
def eval_model(args):
    ...
    for question_type in args.question_types:
        args.question_file = args.pope_path + f"{args.dataset_name}_pope_{question_type}.json"
        ...
        for line in tqdm(questions):
            ...
            with torch.inference_mode():
                ...
                # intact_scores = torch.cat(scores_tuple[:-1], dim=0)
...
if __name__ == "__main__":
    ...
    args.pope_path = "/apdcephfs_cq8/share_1367250/dichyang/data/benchmarks/pope/"
    ...
    args.result_path = '/apdcephfs_cq8/share_1367250/dichyang/data/benchmarks/pope/results/' + get_timestamp()
    ...
    if args.dataset_name == "coco" or args.dataset_name == "aokvqa":
        args.image_folder = "/apdcephfs_cq8/share_1367250/dichyang/data/benchmarks/pope/coco_pope"
    ...
    answer_file_prefix = 'llava15_pope_closeEndVqa_answers_image'
    args.answers_file_name = answer_file_prefix + f'_{args.image_content}_{args.decode_method}_{args.decode_assist}-{args.mm_vision_select_feature}-{args.mm_vision_reduction_scale}.jsonl'
