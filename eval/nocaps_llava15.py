...
sys.path.append('your/path/to/RedundancyCodebook/src/experiments/')
...
def eval_model(args):
    ...
    # all_nocaps_data = all_nocaps_data  # [300:400]  # TODO
...
if __name__ == "__main__":
    ...
    args.nocaps_path = '/apdcephfs_cq8/share_1367250/dichyang/data/benchmarks/nocaps/'
    args.nocaps_img_path = args.nocaps_path + 'images/'
    args.nocaps_split = ["in-domain", "near-domain", "out-domain"]
    save_path = '/apdcephfs_cq8/share_1367250/dichyang/data/benchmarks/nocaps/'
    ...
    answer_file_prefix = 'llava15_nocaps_zeroshot_captions_image'
